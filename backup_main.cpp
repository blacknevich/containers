...
//
//    action_announce("base");
//    my.assign(99 * _ratio, 1);
//    my.resize(50 * _ratio);
//    my.reserve(50 * _ratio);
//    std::cout << "Size: " << my.size() << std::endl;
//    std::cout <<  "Capacity: " << my.capacity() << std::endl;
//    my.resize(70 * _ratio);
//    std::cout << "Size: " << my.size() << std::endl;
//    std::cout <<  "Capacity: " << my.capacity() << std::endl;
//    my.resize(153 * _ratio, 0);
//    std::cout << "Size: " << my.size() << std::endl;
//    std::cout <<  "Capacity: " << my.capacity() << std::endl;
//    std::cout << my[65] << std::endl;
//
//    action_announce("etalon");
//    std::vector<int> etalon(42);
//
//    etalon.assign(99 * _ratio, 1);
//    etalon.resize(50 * _ratio);
//    etalon.reserve(50 * _ratio);
//    std::cout << "Size: " << etalon.size() << std::endl;
//    std::cout <<  "Capacity: " << etalon.capacity() << std::endl;
//    etalon.resize(70 * _ratio);
//    std::cout << "Size: " << etalon.size() << std::endl;
//    std::cout <<  "Capacity: " << etalon.capacity() << std::endl;
//    etalon.resize(153 * _ratio, 0);
//    std::cout << "Size: " << etalon.size() << std::endl;
//    std::cout <<  "Capacity: " << etalon.capacity() << std::endl;
//    std::cout << etalon[65] << std::endl;
// =============================================================================
